...
public class BinasClient implements BinasPortType {
    ...
    private void uddiLookup() throws BinasClientException {
    	try {
			...
			throw new BinasClientException("Error connecting to UDDI.", e);
		}
    }
	...
	// remote invocation methods ----------------------------------------------
	 ...
	 @Override
	 public java.util.List<StationView> listStations(Integer numberOfStations, CoordinatesView coordinates) {
